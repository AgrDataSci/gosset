...
# @return a logical value where TRUE indicates that the object is of class "grouped_rankings"
# @examples
...
# @param object an object to have its class tested
# @return a logical value where TRUE indicates that the object is of class "rankings"
# @examples
...
# @param object an object to have its class tested
# @return a logical value where TRUE indicates that the object is of class "paircomp"
# @examples
...
# Test a tibble object
# @param object an object to have its class tested
# @return a logical value where TRUE indicates that the object is of class "tbl_df"
# @examples
...
# .rank_decimal(c(0.2, -1.2, 2.3, 0.2, 0.4, -3.3), id = c(1,1,1,2,2,2))
...
# @split a character or index of 'data' to indicate the variable to split the data
# @value a character or index of 'data' to indicate the variable to sort data
