...
[![codecov](https://codecov.io/gh/agrobioinfoservices/gosset/branch/master/graph/badge.svg){data-external="1"}](https://codecov.io/gh/agrobioinfoservices/gosset)
[![CRAN status](https://www.r-pkg.org/badges/version/gosset){data-external="1"}](https://cran.r-project.org/package=gosset)
<!-- badges: end -->
