...
ranking, considering if items with higher numeric values should be ranked first or
last. The function ``rank_binomial`` transforms data in rankings format into
...
load("D:/GitHub/gosset/data/nicabean.rda")
