...
Than we prepare the matrix to compute the rainfall indices using the function `rainfall()` from package climatrends. We compute rainfall indices for the first 45 days after planting. 
